...
public class ElementUtils {
    ...
    public WebDriverWait fluentWaitSettings(WebDriver driver, long timeout, Duration pollingInterval) {
        WebDriverWait fluentWait = new WebDriverWait(driver, timeout);
    ...
    /**
     * Closes any new tabs/windows opened by the webdriver besides the original.
     *
    ...
    public boolean checkAlert() {
        try {
            ...
            WebDriverWait waitInAlert = new WebDriverWait(driver, 10);
